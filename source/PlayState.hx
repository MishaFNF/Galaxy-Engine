...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['learn how to play this game, pls', 0.2], //From 0% to 19%
		['DIE, RIGHT NOW!', 0.4], //From 20% to 39%
		['You make me Angry >:[', 0.5], //From 40% to 49%
		['Bruh :/', 0.6], //From 50% to 59%
		['Um, what happened with you?', 0.69], //From 60% to 68%
		['Yup, nice one!', 0.7], //69%
		['You good, buddy :]', 0.8], //From 70% to 79%
		['Great is, idk what to say', 0.9], //From 80% to 89%
		['Cool!', 1], //From 90% to 99%
		['Wow, you beautiful :]', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	public function updateScore(miss:Bool = false)
	{
		...
		+ ' | Misses - ' + songMisses
		+ ' | Rating - ' + ratingName
		+ (ratingName != 'Waiting for notes' ? ' (${Highscore.floorDecimal(ratingPercent * 100, 2)}%) - $ratingFC' : '');
